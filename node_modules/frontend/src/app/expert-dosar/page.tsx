...
export default function ExpertDosarPage() {
  ...
  const isDuplicatComplete =
    ...
    (duplicateReason && identityDocumentType);
  ...
  function continueToUpload() {
    ...
    const params = new URLSearchParams({
      ...
      tipActIdentitate: identityDocumentType,
    });
          ...
          {operationSlug === "duplicat-talon" && (
            <>
              <Question title="3. Motiv duplicat talon:">
                <Option
                  label="Pierdut"
                  active={duplicateReason === "pierdut"}
                  onClick={() => setDuplicateReason("pierdut")}
                />
                <Option
                  label="Furat"
                  active={duplicateReason === "furat"}
                  onClick={() => setDuplicateReason("furat")}
                />
                <Option
                  label="Deteriorat"
                  active={duplicateReason === "deteriorat"}
                  onClick={() => setDuplicateReason("deteriorat")}
                />
              </Question>

              <Question title="4. Tip act identitate:">
                <Option
                  label="Carte de identitate"
                  active={identityDocumentType === "ci"}
                  onClick={() => setIdentityDocumentType("ci")}
                />
                <Option
                  label="Carte de identitate electronică"
                  active={identityDocumentType === "cie"}
                  onClick={() => setIdentityDocumentType("cie")}
                />
              </Question>
            </>
          )}
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "10px", color: "#4b5563", lineHeight: 1.7 }}>
        ...
        <br />
        Tip act identitate:{" "}
        {props.identityDocumentType === "ci"
          ? "Carte de identitate"
          : props.identityDocumentType === "cie"
